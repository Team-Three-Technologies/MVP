...
export class ElectronIpc {
  ...
  public async searchDocuments(filters: SearchRequestDTO): Promise<DocumentDetailsResponseDTO[]> {
    try {
      const response = await this.api.document.searchDocuments(filters);
