    ...
    public addFilter(filter: SearchFilterDTO):void
    {
        ...
        switch (filter.type) {
            ...
            case 'Impronta crittografica allegato (hash)':
                filter.type = 'DocumentoInformatico.Allegati.IndiceAllegati.{num}.IdDoc.ImprontaCrittograficaDelDocumento.Impronta';
                this.metadataOnlyFilters.push(filter);
            break;
            ...
            case 'Versione prodotto software':
                filter.type = 'DocumentoInformatico.IdentificativoDelFormato.ProdottoSoftware.VersioneProdotto';
                this.metadataOnlyFilters.push(filter);
            break;
