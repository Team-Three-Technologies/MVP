...
export class DocumentMapper {
  ...
  public toDomain(parsedDocument: DocumentParsingResult): Document {
    ...
    const metadata: Metadata[] = [
      new Metadata(
        'IdDoc.Identificativo',
        parsedDocument.documentMetadata.Document.DocumentoInformatico.IdDoc.Identificativo,
        MetadataTypeEnum.STRING,
      ),
      new Metadata(
        'IdDoc.ImprontaCrittograficaDelDocumento.Impronta',
        parsedDocument.documentMetadata.Document.DocumentoInformatico.IdDoc
          .ImprontaCrittograficaDelDocumento.Impronta,
        MetadataTypeEnum.BASE64,
      ),
      new Metadata(
        'ModalitaDiFormazione',
        parsedDocument.documentMetadata.Document.DocumentoInformatico.ModalitaDiFormazione,
        MetadataTypeEnum.STRING,
      ),
      new Metadata(
        'TipologiaDocumentale',
        parsedDocument.documentMetadata.Document.DocumentoInformatico.TipologiaDocumentale,
        MetadataTypeEnum.STRING,
      ),
      new Metadata(
        'DatiDiRegistrazione.TipologiaDiFlusso',
        parsedDocument.documentMetadata.Document.DocumentoInformatico.DatiDiRegistrazione
          .TipologiaDiFlusso,
        MetadataTypeEnum.STRING,
      ),
      new Metadata(
        'ChiaveDescrittiva.Oggetto',
        parsedDocument.documentMetadata.Document.DocumentoInformatico.ChiaveDescrittiva.Oggetto,
        MetadataTypeEnum.STRING,
      ),
      new Metadata(
        'Allegati.NumeroAllegati',
        String(
          parsedDocument.documentMetadata.Document.DocumentoInformatico.Allegati.NumeroAllegati,
        ),
        MetadataTypeEnum.NUMBER,
      ),
      new Metadata(
        'Riservato',
        String(parsedDocument.documentMetadata.Document.DocumentoInformatico.Riservato),
        MetadataTypeEnum.BOOLEAN,
      ),
      new Metadata(
        'IdentificativoDelFormato.Formato',
        parsedDocument.documentMetadata.Document.DocumentoInformatico.IdentificativoDelFormato
          .Formato,
        MetadataTypeEnum.STRING,
      ),
      new Metadata(
        'Verifica.FirmatoDigitalmente',
        String(
          parsedDocument.documentMetadata.Document.DocumentoInformatico.Verifica
            .FirmatoDigitalmente,
        ),
        MetadataTypeEnum.BOOLEAN,
      ),
      new Metadata(
        'Verifica.SigillatoElettronicamente',
        String(
          parsedDocument.documentMetadata.Document.DocumentoInformatico.Verifica
      ...
      new Metadata(
        'Verifica.MarcaturaTemporale',
        String(
          parsedDocument.documentMetadata.Document.DocumentoInformatico.Verifica.MarcaturaTemporale,
        ),
        MetadataTypeEnum.BOOLEAN,
      ),
      new Metadata(
        'Verifica.ConformitaCopieImmagineSuSupportoInformatico',
        String(
          parsedDocument.documentMetadata.Document.DocumentoInformatico.Verifica
      ...
      new Metadata(
        'NomeDelDocumento',
        parsedDocument.documentMetadata.Document.DocumentoInformatico.NomeDelDocumento,
        MetadataTypeEnum.STRING,
      ),
      new Metadata(
        'VersioneDelDocumento',
        parsedDocument.documentMetadata.Document.DocumentoInformatico.VersioneDelDocumento,
        MetadataTypeEnum.STRING,
      ),
    ];
    ...
    metadata.push(
      ...[
        ...(parsedDocument.documentMetadata.Document.DocumentoInformatico.IdDoc
          .ImprontaCrittograficaDelDocumento.Algoritmo
          ? [
              new Metadata(
                'IdDoc.ImprontaCrittograficaDelDocumento.Algoritmo',
                parsedDocument.documentMetadata.Document.DocumentoInformatico.IdDoc
                  .ImprontaCrittograficaDelDocumento.Algoritmo,
                MetadataTypeEnum.STRING,
              ),
          ...
          : []),
        ...(parsedDocument.documentMetadata.Document.DocumentoInformatico.Classificazione
          ?.IndiceDiClassificazione
          ? [
              new Metadata(
                'Classificazione.IndiceDiClassificazione',
                parsedDocument.documentMetadata.Document.DocumentoInformatico.Classificazione
                  .IndiceDiClassificazione,
                MetadataTypeEnum.STRING,
              ),
        ...
        ...(parsedDocument.documentMetadata.Document.DocumentoInformatico.Classificazione
          ...
          ? [
              new Metadata(
                'Classificazione.PianoDiClassificazione',
                parsedDocument.documentMetadata.Document.DocumentoInformatico.Classificazione
                  ?.PianoDiClassificazione,
                MetadataTypeEnum.STRING,
              ),
          ...
          : []),
        ...(parsedDocument.documentMetadata.Document.DocumentoInformatico.IdentificativoDelFormato
          .ProdottoSoftware?.NomeProdotto
          ? [
              new Metadata(
                'IdentificativoDelFormato.ProdottoSoftware.NomeProdotto',
          ...
          : []),
        ...(parsedDocument.documentMetadata.Document.DocumentoInformatico.IdentificativoDelFormato
          .ProdottoSoftware?.VersioneProdotto
          ? [
              new Metadata(
                'IdentificativoDelFormato.ProdottoSoftware.VersioneProdotto',
                parsedDocument.documentMetadata.Document.DocumentoInformatico
                  .IdentificativoDelFormato.ProdottoSoftware?.VersioneProdotto,
                MetadataTypeEnum.STRING,
              ),
          ...
          : []),
        ...(parsedDocument.documentMetadata.Document.DocumentoInformatico.IdentificativoDelFormato
          .ProdottoSoftware?.Produttore
          ? [
              new Metadata(
                'IdentificativoDelFormato.ProdottoSoftware.Produttore',
                parsedDocument.documentMetadata.Document.DocumentoInformatico
                  .IdentificativoDelFormato.ProdottoSoftware?.Produttore,
                MetadataTypeEnum.STRING,
              ),
          ...
          : []),
        ...(parsedDocument.documentMetadata.Document.DocumentoInformatico
          .IdIdentificativoDocumentoPrimario?.Identificativo
          ? [
              new Metadata(
                'IdIdentificativoDocumentoPrimario.Identificativo',
                parsedDocument.documentMetadata.Document.DocumentoInformatico
          ...
          : []),
        ...(parsedDocument.documentMetadata.Document.DocumentoInformatico
          .IdIdentificativoDocumentoPrimario?.ImprontaCrittograficaDelDocumento.Impronta
          ? [
              new Metadata(
                'IdIdentificativoDocumentoPrimario.ImprontaCrittograficaDelDocumento.Impronta',
                parsedDocument.documentMetadata.Document.DocumentoInformatico
          ...
          : []),
        ...(parsedDocument.documentMetadata.Document.DocumentoInformatico
          .IdIdentificativoDocumentoPrimario?.ImprontaCrittograficaDelDocumento.Algoritmo
          ? [
              new Metadata(
                'IdIdentificativoDocumentoPrimario.ImprontaCrittograficaDelDocumento.Algoritmo',
                parsedDocument.documentMetadata.Document.DocumentoInformatico
    ...
    if (tipoRegistro.Nessuno) {
      ...
      metadata.push(
        ...[
          ...
          new Metadata(
            'DatiDiRegistrazione.TipoRegistro.Nessuno.DataDocumento',
            r.DataDocumento,
            MetadataTypeEnum.DATE,
          ),
          ...(r.OraDocumento
            ? [
                new Metadata(
                  'DatiDiRegistrazione.TipoRegistro.Nessuno.OraDocumento',
                  r.OraDocumento,
                  MetadataTypeEnum.TIME,
                ),
              ]
            : []),
          new Metadata(
            'DatiDiRegistrazione.TipoRegistro.Nessuno.NumeroDocumento',
            r.NumeroDocumento,
            MetadataTypeEnum.STRING,
          ),
        ],
      ...
      metadata.push(
        ...[
          ...
          new Metadata(
            ...
            r.DataProtocollazioneDocumento,
            MetadataTypeEnum.DATE,
          ),
          ...(r.OraProtocollazioneDocumento
            ...
            : []),
          new Metadata(
            'DatiDiRegistrazione.TipoRegistro.ProtocolloOrdinario_ProtocolloEmergenza.NumeroProtocolloDocumento',
            r.NumeroProtocolloDocumento,
            MetadataTypeEnum.STRING,
          ),
          new Metadata(
            'DatiDiRegistrazione.TipoRegistro.ProtocolloOrdinario_ProtocolloEmergenza.CodiceRegistro',
            r.CodiceRegistro,
            MetadataTypeEnum.STRING,
          ),
        ],
      ...
      metadata.push(
        ...[
          ...
          ...(r.OraRegistrazioneDocumento
            ...
            : []),
          new Metadata(
            'DatiDiRegistrazione.TipoRegistro.Repertorio_Registro.NumeroRegistrazioneDocumento',
            r.NumeroRegistrazioneDocumento,
            MetadataTypeEnum.STRING,
          ),
          new Metadata(
            'DatiDiRegistrazione.TipoRegistro.Repertorio_Registro.CodiceRegistro',
            r.CodiceRegistro,
            MetadataTypeEnum.STRING,
          ),
        ],
    ...
    metadata.push(
      ...(
        parsedDocument.documentMetadata.Document.DocumentoInformatico.ChiaveDescrittiva
          .ParoleChiave ?? []
      ).map(
        (pc, i) => new Metadata(`ChiaveDescrittiva.ParoleChiave.${i}`, pc, MetadataTypeEnum.STRING),
      ),
    );

    metadata.push(
      ...(
        parsedDocument.documentMetadata.Document.DocumentoInformatico.Allegati.IndiceAllegati ?? []
      ).flatMap((all, i) => [
        new Metadata(
          `Allegati.IndiceAllegati.Descrizione.${i}`,
          all.Descrizione,
          MetadataTypeEnum.STRING,
        ),
        new Metadata(
          `Allegati.IndiceAllegati.IdDoc.Identificativo.${i}`,
          all.IdDoc.Identificativo,
          MetadataTypeEnum.STRING,
        ),
        new Metadata(
          `Allegati.IndiceAllegati.IdDoc.ImprontaCrittograficaDelDocumento.Impronta.${i}`,
          all.IdDoc.ImprontaCrittograficaDelDocumento.Impronta,
          MetadataTypeEnum.BASE64,
        ),
        new Metadata(
          `Allegati.IndiceAllegati.IdDoc.ImprontaCrittograficaDelDocumento.Algoritmo.${i}`,
          all.IdDoc.ImprontaCrittograficaDelDocumento.Algoritmo ?? '',
          MetadataTypeEnum.STRING,
        ),
      ]),
    );
    ...
    metadata.push(
      ...(parsedDocument.documentMetadata.Document.DocumentoInformatico.Agg.TipoAgg ?? []).flatMap(
        (agg, i) => [
    ...
    metadata.push(
      ...(
        ...
        new Metadata(
          `TracciatureModificheDocumento.TipoModifica.${i}`,
          mod.TipoModifica,
          MetadataTypeEnum.STRING,
        ),
        new Metadata(
          `TracciatureModificheDocumento.DataModifica.${i}`,
          mod.DataModifica,
          MetadataTypeEnum.DATE,
        ),
        new Metadata(
          `TracciatureModificheDocumento.OraModifica.${i}`,
          mod.OraModifica ?? '',
          MetadataTypeEnum.TIME,
        ),
        new Metadata(
          `TracciatureModificheDocumento.IdDocVersionePrecedente.Identificativo.${i}`,
          mod.IdDocVersionePrecedente.Identificativo,
          MetadataTypeEnum.STRING,
        ),
        new Metadata(
          `TracciatureModificheDocumento.IdDocVersionePrecedente.ImprontaCrittograficaDelDocumento.Impronta.${i}`,
          mod.IdDocVersionePrecedente.ImprontaCrittograficaDelDocumento.Impronta,
          MetadataTypeEnum.BASE64,
        ),
        new Metadata(
          `TracciatureModificheDocumento.IdDocVersionePrecedente.ImprontaCrittograficaDelDocumento.Algoritmo.${i}`,
          mod.IdDocVersionePrecedente.ImprontaCrittograficaDelDocumento.Algoritmo ?? '',
          MetadataTypeEnum.STRING,
        ),
      ]),
    );
    ...
    metadata.push(
      ...[
        new Metadata(
          ...
          String(
            parsedDocument.documentMetadata.Document.ArchimemoData.DocumentInformation.FilesCount,
          ),
          MetadataTypeEnum.NUMBER,
        ),
        new Metadata(
          'ArchimemoData.DocumentInformation.TotalSize',
          `${String(parsedDocument.documentMetadata.Document.ArchimemoData.DocumentInformation.TotalSize['#text'])} ${String(parsedDocument.documentMetadata.Document.ArchimemoData.DocumentInformation.TotalSize['@_unit'])}`.trim(),
          MetadataTypeEnum.STRING,
        ),
      ],
    );

    const entries = this.mapRoles(
